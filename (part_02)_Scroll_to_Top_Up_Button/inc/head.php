...
<html>
	<head>
        ...
        #gototop{background: url("img/scroll.png")no-repeat scroll 0 0; bottom: 10px; right: 10px; position: fixed; width: 150px; height: 150px; cursor: pointer;}
	...
	<body>
        <div class="phpcoding">
			<section class="headeroption">
			        <h2><?php echo "Real use of jQuery: Scroll to Top/Up Button"; ?></h2>
			</section>
